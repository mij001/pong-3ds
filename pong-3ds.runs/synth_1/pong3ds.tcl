...
synth_design -top pong3ds -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef pong3ds.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file pong3ds_utilization_synth.rpt -pb pong3ds_utilization_synth.pb"  } 
