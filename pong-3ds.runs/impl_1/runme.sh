...
HD_PWD='/home/inomal/projects/xilinx/pong-3ds/pong-3ds.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pong3ds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pong3ds.tcl -notrace
